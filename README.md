...
Этот небольшой проект является моим учебным. В нем я, на React/Redux реализовал некоторый функционал сайта trello.com, а также скопировал интерфейс. 
На сайте можно:
- регестрировать новых пользователей;
- создавать/удалять доски;
- приглашать людей в команду;
